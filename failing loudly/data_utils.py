...
def adversarial_samples(dataset):
    ...
    external_dataset_path = './datasets/'
    if dataset == 'mnist':
        f = open(external_dataset_path + r'mnist_X_adversarial.npy', 'rb')
        x_test = np.load(f,allow_pickle=True)
        f = open(external_dataset_path + r'mnist_y_adversarial.npy', 'rb')
        y_test = np.load(f,allow_pickle=True)
    elif dataset == 'cifar10':
        f = open(external_dataset_path + r'cifar10_X_adversarial.npy', 'rb')
        x_test = np.load(f,allow_pickle=True)
        f = open(external_dataset_path + r'cifar10_y_adversarial.npy', 'rb')
        y_test = np.load(f,allow_pickle=True)
